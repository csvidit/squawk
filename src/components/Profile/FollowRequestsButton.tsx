...
const FollowRequestsButton = () => {
    return (
      ...
      >
        <motion.div className="flex flex-row space-x-1 justify-center items-center pl-4 pr-4 pt-1 pb-1 border-none text-md lg:text-lg font-medium">
          <p className="text-sky-500 group-hover:text-sky-700 transition-all"><SlUserFollow /></p>
          <p className="flex">Follow Requests</p>
        </motion.div>
      </Link>
    );
  };
