...
const LandingNav = () => {
  return (
    <motion.div className="bg-zinc-100 rounded-full z-10 fixed drop-shadow-md shadow-white self-center bottom-12 flex flex-row pt-2 pb-2 pl-4 pr-4 space-x-1 items-center font-sans font-medium text-md">
